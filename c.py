...
class ChatClient:
    def __init__(self):
        ...
        # Initialize the GUI with a callback function
        self.gui = GUI(self.display_message)
    ...
    def login(self, username, password):
        ...
        validation_result = self.client_socket.recv(1024).decode('utf-8')

        if validation_result == "VALID":
            print("Login successful.")
            # Now, you can enable the main chat interface or any other functionality
        else:
